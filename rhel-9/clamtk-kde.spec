...
%{__install} -D -m0644 clamtk-kde.desktop %{buildroot}%{_datadir}/kservices5/ServiceMenus/clamtk-kde.desktop
...
%changelog
* Tue Jan 16 2024 Dave M. <dave.nerd@gmail.com> - 0.20-1
- Upgraded to 0.20.
- Dependency is now kf5-filesystem.
- Desktop file is now installed under kservices5 ServiceMenus.
